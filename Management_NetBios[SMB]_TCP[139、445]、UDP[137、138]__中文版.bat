...
ECHO --------------------------------------------------------------
ECHO [1] 更改RDP埠
ECHO [2] 管理NetBIOS[SMB] TCP 139、445
ECHO [3] 管理NetBIOS UDP 137、138
ECHO [4] 查看TCP、UDP連接埠
ECHO --------------------------------------------------------------
ECHO.
CHOICE /C 4321 /N /M "選擇功能[1~4]: "
IF ERRORLEVEL 4 (
	GOTO RDP_Info
...
ECHO.
CHOICE /C NYE /N /M "是否更改連接埠(按下E離開;按下N返回主選單): "
IF ERRORLEVEL 3 (
	GOTO Exit
)ELSE IF ERRORLEVEL 2 (
...
ECHO.
ECHO 將TCP/IP NetBIOS Helper服務設置關閉中...
ECHO.
